  ...
  create  table "postgres"."public_marts_analytics"."rep_sales_funnel_monthly__dbt_tmp"
  ...
  (
    ...
    select
        ...
        stage_id,
        stage_start_at
    from "postgres"."public_public"."int_deal_stage_history"
...
funnel_steps as (
    ...
    select
        ...
        funnel_step,
        funnel_order
    from "postgres"."public_public"."int_funnel_stages"
...
deal_data as (
    ...
    select
        deal_id,
        created_at
    from "postgres"."public_public"."int_deal_metadata"
